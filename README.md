## Updates
This Repo is ported from Big Data Europe and has the following updates:

* Python Version updated to 3.7 (on Zeppelin and Spark Worker)
* Zeppelin Version 0.8.X added
